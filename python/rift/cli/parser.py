...
def _add_service_group(commands) -> None:
    ...
    telemetry = _parser(sub, "telemetry", "Read live resource telemetry or a completed resource report")
    telemetry.add_argument("--service", default="chat")
    telemetry.add_argument("--node")
    telemetry.add_argument("--session-id")
    telemetry.add_argument("--report-id")
    telemetry.add_argument("--report", action="store_true", help="Show completed resource reports")
    telemetry.add_argument("--signals", action="store_true", help="Show sustained resource threshold signals")
    telemetry.add_argument("--latest", action="store_true", help="Show the latest sample (default)")

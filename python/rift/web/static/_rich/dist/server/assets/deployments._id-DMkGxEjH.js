...
import { D as useService, E as useRevisions, O as useServiceTelemetryAccounting, P as SlidersHorizontal, T as useResourceReports, _ as useLogs, a as StatDot, d as useBenchmarks, i as SourceBadge, j as useTelemetryLatest, l as useBenchmarkProfiles, n as PageHeader, o as AppShell, p as useEvaluations, r as Panel, t as KV, u as useBenchmarkSuiteRuns, w as useReports } from "./primitives-C0rE_XYj.js";
import { i as cn, r as rift, s as createLucideIcon, t as Unavailable } from "./unavailable-DPmDjngQ.js";
import { n as Copy, t as Gauge } from "./gauge-zgEnU7h8.js";
import { t as LoaderCircle } from "./loader-circle-DKpq2ojB.js";
import { t as RotateCcw } from "./rotate-ccw-CV-YP6PN.js";
import { t as ShieldCheck } from "./shield-check-BfHyH4nq.js";
import { r as relativeTime, t as bytes } from "./format-gcr4F9Vx.js";
import { t as Route } from "./deployments._id-DlMqRPjd.js";
/**
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				service && tab === "benchmarking" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BenchmarkingTab, { service }),
...
var FALLBACK_BENCHMARK_PROFILES = [
	{
		id: "smoke",
		name: "Smoke",
...
function BenchmarkingTab({ service }) {
	...
	const [selected, setSelected] = (0, import_react.useState)(["smoke"]);
	const [study, setStudy] = (0, import_react.useState)("repeatability");
	const [busy, setBusy] = (0, import_react.useState)(false);
	const [error, setError] = (0, import_react.useState)(null);
	const toggle = (id) => {
	...
	const run = async () => {
		...
		setError(null);
		try {
			await rift.benchmarkProfilesRun(service.name, selected.length ? selected : ["smoke"], selected.includes("research") ? { research: { recipe: study } } : {});
			runs.refetch();
		} catch (err) {
			setError(err instanceof Error ? err.message : String(err));
		} finally {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
			...
			aside: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "rift-mono text-[11px] text-ink-secondary",
				children: "No service settings are changed"
			}),
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[13px] text-ink-secondary max-w-3xl",
					children: "Choose one or more substantial profiles. RIFT compiles them into one reviewed run and executes the measured phases sequentially so load from one profile does not distort another."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: profiles.map((profile) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: cn("flex gap-3 rounded-[4px] border p-3 cursor-pointer transition-colors", checked ? "border-primary bg-primary/5" : "border-border hover:bg-muted/40"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-[12px] text-ink-secondary",
										children: profile.purpose
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-2 block rift-mono text-[10.5px] text-ink-secondary",
										children: profile.plannedWorkload
									})
								]
							})]
						}, profile.id);
				...
				selected.includes("research") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-4 max-w-md grid gap-1 text-[12px]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							className: "rift-label",
							htmlFor: "research-recipe",
							children: "Research recipe"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "paired",
									children: "Paired comparison"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "factorial",
									children: "Factorial ablation"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "context_position",
									children: "Context position"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "prefix_reuse",
									children: "Prefix reuse"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-[11px] text-ink-secondary",
							children: "The protocol, seed, controls, and uncertainty analysis are recorded with the run."
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [
							busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gauge, { className: "size-4" }),
							"Run ",
							selected.length || 1,
							" profile",
							selected.length === 1 ? "" : "s"
						...
						className: "rift-mono text-[11px] text-ink-secondary",
						children: ["Smoke is selected by default · ", selected.join(" → ") || "smoke"]
					})]
				}),
			...
			bodyClassName: "p-0",
			children: runs.unavailable ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "px-4 py-6 text-[12px] text-ink-secondary",
				children: "Benchmark history is unavailable from this controller."
			}) : !runs.data?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "px-4 py-6 text-[12px] text-ink-secondary",
				children: "No suite runs recorded yet."
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "overflow-x-auto",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					className: "w-full min-w-[720px] text-[12px] rift-mono",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: runs.data.map((run) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "px-4",
								children: run.durationSeconds == null ? "unavailable" : `${run.durationSeconds.toFixed(1)}s`
							})
						]
					}, run.runId)) })]
				})
